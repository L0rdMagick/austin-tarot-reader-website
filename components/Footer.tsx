...
const contactLinks = [
    ...
    { 
        name: 'info@austintarotreader.com', 
  ...
  return (
    <footer className="w-full bg-secondary border-t border-white/10 mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 font-sans">
              ...
              <li><Link href="/privacy" className="hover:text-primary transition-colors text-foreground">Privacy Policy</Link></li>
              <li><Link href="/terms" className="hover:text-primary transition-colors text-foreground">Terms of Service</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center text-sm text-foreground/50 flex flex-col items-center gap-2">
