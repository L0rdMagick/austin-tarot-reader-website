      ...
      <main className="flex flex-col items-center relative z-10">
        ...
        <section className="w-full text-center pt-12 pb-6 md:pt-16 md:pb-8 flex flex-col items-center justify-center px-4">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center gap-4">
            ...
            <a href="sms:15125477129?body=Hi%20Daniel,%20I'd%20like%20to%20ask%20about%20booking%20a%20tarot%20reading." className="w-full sm:w-auto bg-surface-elevated text-gold border border-gold/40 font-bold py-3.5 px-6 rounded-xl text-base hover:bg-surface-overlay transition-colors duration-300 font-sans">
        ...
        <div className="w-full max-w-5xl mx-auto space-y-12 md:space-y-16 px-4 sm:px-8 md:px-12 pb-16 pt-6">
          ...
          <section className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <div className="pt-2">
              <Link href="/about" className="font-sans text-base text-gold hover:underline inline-flex items-center gap-1 font-semibold">
          ...
          <section className="bg-surface p-8 sm:p-12 rounded-2xl border border-gold/30 text-center space-y-8 shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
              <div className="bg-surface-elevated p-6 rounded-xl border border-white/10 space-y-3 relative">
          ...
          <section className="text-center space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
              {/* Card 1: 30-Min */}
              <div className="bg-surface/80 p-8 rounded-2xl border border-white/10 flex flex-col justify-between hover:border-gold/40 transition-all duration-300 shadow-xl">
                <div>
              ...
              <div className="bg-surface p-8 rounded-2xl border-2 border-gold shadow-2xl shadow-gold/15 flex flex-col justify-between relative transform md:-translate-y-2">
            ...
            <div className="pt-4">
              <Link href="/services" className="font-sans text-base text-gold hover:underline inline-flex items-center gap-1 font-semibold">
