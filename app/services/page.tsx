...
const services = [
  { title: 'In-Depth 60-Minute Tarot Reading', duration: '1 hr', price: '$85.00', description: 'An extended, 15-card reading ideal for seeking deep clarity on a single issue or life theme. Perfect for spiritual growth and transformational insight. Available in-person in Austin, by phone, or video call.', bookingLink: 'https://book.squareup.com/appointments/nsc0u2gmu4vhoy/location/YB8VMMKGCHGN0/services/BF72ZKQM74NPNZ3FTYZLARXT' },
  { title: 'Love & Relationship Reading', duration: '1 hr', price: '$85.00', description: 'This 60-minute session is centered on your romantic life. Using a 15-card spread, this reading offers guidance on current relationships, future love, or emotional healing, helping you understand what to hold onto and what to let go of.', bookingLink: 'https://book.squareup.com/appointments/nsc0u2gmu4vhoy/location/YB8VMMKGCHGN0/services/MTY5Q7OG2SPMK6S5AUMAUPUJ' },
  ...
  { title: 'Career & Money Tarot Reading', duration: '1 hr', price: '$85.00', description: 'A 60-minute reading focused on career direction, job changes, financial decisions, or your overall sense of purpose. This spread offers intuitive guidance to help you make confident, aligned decisions for your path forward.', bookingLink: 'https://book.squareup.com/appointments/nsc0u2gmu4vhoy/location/YB8VMMKGCHGN0/services/Y35MKZALF3RNQPE6OSOUDG5Q' },
];
          ...
          {services.map((service) => (
            <div key={service.title} className="bg-secondary p-8 rounded-xl border border-white/10 flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-grow">
                {/* Note: We are not animating the individual service titles to avoid excessive motion on a list */}
