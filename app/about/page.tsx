...
// --- Testimonials Data ---
// DEBUG: To feature your best Google reviews, paste the quote and the client's name here.
// I recommend picking 2 or 3 of your most impactful reviews.
const testimonials = [
  {
    quote: "This was an absolutely amazing experience. The reading was so insightful and accurate, and it gave me the clarity I was desperately looking for. I can't recommend them enough!",
    author: "Jessica M.",
  },
  {
    quote: "I was a little nervous, but they made me feel so comfortable and at ease. The reading resonated deeply and provided actionable guidance that I've already started using in my life.",
    author: "David R.",
  },
  {
    quote: "Truly a gifted reader. They have a wonderful, calming presence and a unique way of interpreting the cards that is both profound and easy to understand. A session is a true gift to yourself.",
    author: "Samantha K.",
  }
];
    ...
    <main className="flex min-h-screen flex-col items-center p-4 sm:p-8 md:p-12">
      <div className="w-full max-w-5xl mx-auto space-y-24 md:space-y-32">
        ...
        <section className="text-center pt-16">
          ...
          <a
            href="YOUR_MAIN_BOOKING_LINK_HERE" // TODO: Add your main booking link
            target="_blank"
        ...
        <section className="text-center">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[rgb(var(--secondary-rgb))] p-8 rounded-xl border border-white/10">
              ...
              <p className="mt-2 font-sans text-[rgb(var(--foreground-rgb))] opacity-90">Deep dive into your career, relationships, or personal growth to move forward.</p>
            </div>
            <div className="bg-[rgb(var(--secondary-rgb))] p-8 rounded-xl border border-white/10">
              <h3 className="font-cinzel text-2xl font-bold text-[rgb(var(--primary-rgb))]">Couple's Readings</h3>
              <p className="mt-2 font-sans text-[rgb(var(--foreground-rgb))] opacity-90">Explore your relationship dynamics and foster deeper connection in a safe space.</p>
            </div>
            <div className="bg-[rgb(var(--secondary-rgb))] p-8 rounded-xl border border-white/10">
              <h3 className="font-cinzel text-2xl font-bold text-[rgb(var(--primary-rgb))]">Events & Parties</h3>
              <p className="mt-2 font-sans text-[rgb(var(--foreground-rgb))] opacity-90">Add a touch of magic to your Austin event with engaging readings for guests.</p>
            </div>
          </div>
           <Link
            href="/services"
            className="mt-10 inline-block font-sans text-lg text-[rgb(var(--primary-rgb))] hover:underline"
          >
